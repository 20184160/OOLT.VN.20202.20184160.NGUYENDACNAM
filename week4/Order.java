...
public class Order {
    ...
    public void addDigitalVideoDisc(DigitalVideoDisc disc) {
        dem++;
        System.out.println(dem + ". DVD - " + disc.getTitle() + " - " + disc.getCategory() + " - " + disc.getDirector()
    ...
    public void addDigitalVideoDiscmang(DigitalVideoDisc[] disc) {
        if (nbOrder <= MAX_LIMITTED_ORDERS) {
            ...
            while (cont) {
                dem++;
                stt++;
                System.out.println(stt + ". DVD - " + disc[dem - 1].getTitle() + " - " + disc[dem - 1].getCategory()
                ...
                if (dem > 3) {
                    ...
                    do {
                        ...
                        switch (chon) {
                        case 1:
                            System.out.print("Nhập DVD bạn muốn xóa: ");
                            nhapDVD = sc.nextInt();
            ...
            System.out.println("Đã quá giới hạn cho phép");
    }
